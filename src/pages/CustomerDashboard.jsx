...
export const CustomerDashboard = () => {
  ...
  const { user, getStoredSession } = useAuth();
  const sessionUser = (typeof getStoredSession === 'function' ? getStoredSession() : null) || user;
  const displayName = sessionUser?.name || user?.name || currentCustomer?.contactName || 'Om';
  ...
  return (
    <div className="content-wrapper">
      ...
      <div style={{
        ...
        <div>
          <div style={{ display: 'inline-flex', alignItems: 'center', gap: '6px', background: '#e0f2fe', color: '#0369a1', padding: '3px 10px', borderRadius: '20px', fontSize: '0.75rem', fontWeight: 700, marginBottom: '6px' }}>
            <Sparkles size={13} />
            <span>DealFlow360 Customer Portal</span>
          </div>
          <h1 style={{ fontSize: '1.35rem', fontWeight: 800, color: '#0f172a', margin: '0 0 4px 0' }}>
            Good morning, {firstName} 👋
          </h1>
          <p style={{ margin: 0, color: '#64748b', fontSize: '0.875rem', maxWidth: '640px', lineHeight: 1.4 }}>
