...
export const ProductDetail = () => {
  ...
  const relatedProducts = Array.isArray(getAllProducts()) ? getAllProducts().filter(p => p.id !== targetId).slice(0, 4) : [];
      ...
      <div className="product-detail-page" style={{ maxWidth: '1200px', margin: '0 auto', padding: '1rem' }}>
        <ErrorState
          ...
          backButton={{
            ...
            path: window.location.pathname.startsWith('/sales') ? '/sales/products' : '/admin/products'
          }}
        />
      </div>
    );
  ...
  return (
    <div className="product-detail-page" style={{ maxWidth: '1440px', margin: '0 auto' }}>
          ...
          >
            <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: '1rem', borderBottom: '1px solid #f1f5f9', paddingBottom: '0.75rem' }}>
              ...
              <span style={{ fontSize: '0.75rem', fontWeight: 600, color: '#64748b' }}>
                {variants.length} Configurable Attributes
              </span>
            </div>
            ...
            {variants.length === 0 ? (
              ...
              <div className="billing-table-wrap">
                <table className="billing-table" style={{ width: '100%', borderCollapse: 'collapse', textAlign: 'left' }}>
                  ...
                  <tbody>
                    {variants.map((v) => (
                      <tr key={v.id || v.attribute} style={{ borderBottom: '1px solid #f1f5f9' }}>
      ...
      {(() => {
        const priceRules = product.priceRules || [];
        return (
          <div
            style={{
              backgroundColor: '#ffffff',
          ...
          >
            <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: '1rem', borderBottom: '1px solid #f1f5f9', paddingBottom: '0.75rem' }}>
              ...
              <span style={{ fontSize: '0.75rem', fontWeight: 600, color: '#64748b' }}>
                {priceRules.length} Tier Rules Configured
              </span>
            </div>
            ...
            <div className="billing-table-wrap">
              <table className="billing-table" style={{ width: '100%', borderCollapse: 'collapse', textAlign: 'left' }}>
                ...
                <tbody>
                  {priceRules.map((rule) => (
                    <tr key={rule.priceListId || rule.tier} style={{ borderBottom: '1px solid #f1f5f9' }}>
