...
export const CustomerHelp = () => {
  ...
  const displayName = user?.name || currentCustomer?.contactName || 'Om';
  const firstName = displayName.split(' ')[0];
  const displayCompany = user?.company || currentCustomer?.companyName || 'Om Enterprises';
    ...
    <div className="content-wrapper" style={{ width: '100%', boxSizing: 'border-box', paddingBottom: '60px' }}>
      ...
      <div style={{
        ...
        <p style={{ margin: 0, color: '#64748b', fontSize: '0.9375rem', maxWidth: '680px', lineHeight: 1.5 }}>
          Learn how to review proposals, submit counter discounts, navigate approval workflows, and securely confirm quotations for <strong>{displayCompany}</strong>.
        </p>
      </div>
