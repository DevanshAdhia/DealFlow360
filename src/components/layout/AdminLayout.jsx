    ...
    <div className="admin-layout">
      ...
      <aside className={`sidebar ${isCollapsed ? 'collapsed' : ''}`}>
        ...
        <nav className="sidebar-nav">
          ...
          <NavLink to="/admin/discount-rules">{Icons.Rules} {!isCollapsed && <span>Discount Rules</span>}</NavLink>
          <NavLink to="/admin/approval-rules">{Icons.ApprovalRules} {!isCollapsed && <span>Approval Rules</span>}</NavLink>
