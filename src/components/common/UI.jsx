...
export const QuickStatusBadge = ({
  ...
  statusOptions = [
    ...
    { value: 'Negotiating', label: 'Negotiating', variant: 'info' },
  ...
  const currentOpt = statusOptions.find(o => String(o.value).toLowerCase() === normalizedCurrent) || {
    value: currentStatus,
    label: currentStatus ? (String(currentStatus).charAt(0).toUpperCase() + String(currentStatus).slice(1)) : 'UNKNOWN',
    variant: 'info'
  };
...
export const DataTable = ({
  ...
  const [itemsPerPage, setItemsPerPage] = useState(propPageSize);

  // Sync internal page if propCurrentPage is updated
  useEffect(() => {
  ...
  const currentData = showPagination && itemsPerPage > 0 ? data.slice(startIndex, endIndex) : data;
  ...
  return (
    <div style={{ width: '100%', borderTop: '1px solid var(--border)', borderRadius: '0 0 var(--radius-md) var(--radius-md)', overflow: 'hidden' }}>
        ...
        <div style={{
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '16px', flexWrap: 'wrap' }}>
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: '6px' }}>
              <span style={{ fontSize: '0.75rem', color: '#94a3b8' }}>Show:</span>
              <select
                value={itemsPerPage}
                onChange={(e) => {
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '4px' }}>
            <button
              ...
              style={paginationBtnStyle(validPage === 1)}
              title="First Page"
            >
              «
            </button>
                  ...
                  <React.Fragment key={p}>
                    ...
                    <button
                      ...
                      style={{
                        ...
                        padding: '0 8px',
                        borderRadius: '6px',
                        border: p === validPage ? '1px solid #4f46e5' : '1px solid #cbd5e1',
                        backgroundColor: p === validPage ? '#4f46e5' : '#ffffff',
                        color: p === validPage ? '#ffffff' : '#475569',
            ...
            <button
              ...
              style={paginationBtnStyle(validPage === totalPages)}
              title="Next Page"
            >
              Next ›
            </button>
